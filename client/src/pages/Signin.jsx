...
function Signin() {
  return (
    <section class="rounded-md bg-black/70 p-0">
  <div class="flex items-center justify-center bg-white px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
    <div class="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md space-y-5">
      <h2 class="text-2xl font-bold leading-tight text-black">
        Sign in to your account
      </h2>
      <p class="mt-2text-sm text-gray-600">
        Don't have an account?
        <Link to ="/sign-up" className='font-semibold text-black transition-all duration-200 hover:underline'>
          Sign Up
        </Link>
      </p>
